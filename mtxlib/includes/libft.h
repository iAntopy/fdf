...
/*   Updated: 2022/11/16 23:10:45 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_lst	*ft_lstcreate(void *content, size_t size_of);
...
void	ft_lstprint_int(t_lst *lst);
void	ft_lstprint_str(t_lst *lst);
void	ft_lstprint_float(t_lst *lst);
///////////////////////////////////////////
