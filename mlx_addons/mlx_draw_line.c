...
static void	draw_line_low(t_mlx *mlx, int *lims[2], int ds[2], int col)
{
	int	D;
	int	yi;
	int	dy_min_dx;
...
static void	draw_line_high(t_mlx *mlx, int *lims[2], int ds[2], int col)
{
	int	D;
	int	xi;
	int	dx_min_dy;
...
void	mlx_draw_line(t_mlx *mlx, int start[2], int end[2], int color)
{
	int	deltas[2];
	int	*limits[2];
